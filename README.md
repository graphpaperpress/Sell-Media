...
![Single Item Template](http://s.wordpress.org/extend/plugins/sell-media/screenshot-2.png)

### 3. Archive ###
![Archive](http://s.wordpress.org/extend/plugins/sell-media/screenshot-3.png)

### 4. Collection Archive ###
![Collection Archive](http://s.wordpress.org/extend/plugins/sell-media/screenshot-4.png)

### 5. Checkout ###
![Checkout](http://s.wordpress.org/extend/plugins/sell-media/screenshot-5.png)

### 6. Add New Item ###
![Add New Item](http://s.wordpress.org/extend/plugins/sell-media/screenshot-6.png)

### 7. [Optional Premium Extensions](http://graphpaperpress.com/downloads/category/extensions/) ###
![[Optional Premium Extensions](http://graphpaperpress.com/downloads/category/extensions/)](http://s.wordpress.org/extend/plugins/sell-media/screenshot-7.png)

### 8. [Optional Premium Themes](https://graphpaperpress.com/wordpress-themes/sell-media/) ###
![[Optional Premium Themes](https://graphpaperpress.com/wordpress-themes/sell-media/)](http://s.wordpress.org/extend/plugins/sell-media/screenshot-8.png)
