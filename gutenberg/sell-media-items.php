...
if ( ( ! class_exists( 'Sell_Media_Gutenberg_Block_Item_List' ) ) ) {
    /**
     * Class for handling Sell Media Item List Block
     */
    class Sell_Media_Gutenberg_Block_Item_List {
        ...
        public function init() {
            if ( function_exists( 'register_block_type' ) ) {
                ...
                // Add action to register blocks
                add_action( 'init', array( $this, 'register_blocks' ) );             
            }
        }

        /**
         * Register Sell Meida Items Block
         *
         * @access public
         * @since 2.4.6
         */
        public function register_blocks() {
            ...
            // Register sellmediaitems block
            register_block_type(
                $this->block_base . '/' . $this->block_slug,
                array(
                    'render_callback' => array( $this, 'render_block' ),
                    'attributes'      => $this->block_attributes,
                    'editor_script' => array( 'sell_media_all_items_script', 'sell_media_all_items_macy' ),
                    'editor_style' => array( 'sell_media_all_items_style', 'sell_media_items_block_style' )
                )
            );            
        }
         ...
         * [sell_media_gutenberg_recent_items] shortcode.
         *
         * @access public
         * @since 2.4.6
         *
