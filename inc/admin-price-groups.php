...
class SellMediaNavStyleUI {
	...
	public function admin_scripts() {
		...
		if ( 'sell_media_item_page_sell_media_plugin_options' == $screen->id && ! empty( $_GET['tab'] ) && 'sell_media_size_settings' == $_GET['tab'] ) {
			wp_enqueue_script( 'sell_media-admin-price-groups', SELL_MEDIA_PLUGIN_URL . '/js/admin-price-groups.js', array( 'jquery' ) );
