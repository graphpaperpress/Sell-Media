			...
			<td align="center" valign="top" width="100%" bgcolor="#f6f6f6" style="background: #f6f6f6;">
				...
				<table width="600" cellpadding="0" cellspacing="0" align="center">
					...
					<td width="600" align="center" valign="top" style="font-family: Helvetica, Arial, sans-serif; color: #394240; padding: 40px 20px 40px 20px;">
						<h2 style="font-size: 24px; font-weight: bold; text-transform: uppercase; margin: 0 0 24px;"><a href="<?php _e(esc_url( get_bloginfo( 'url' ) ),'sell_media'); ?>" style="color: #394240; border: 0; text-decoration: none;"><?php _e( get_bloginfo( 'name' ) ); ?></a></h2>
					</td>
					</tr>
				</table>
						...
						<td width="600" valign="top">
							<table width="600" cellpadding="0" cellspacing="0" align="center">
								...
								<td width="600" style="padding: 40px 40px 80px 40px;" valign="top" align="center">
									<br />
									<br />
									<h2 style="font-size: 20px; line-height: 30px; color: #444444; margin: 0; padding: 0; font-weight: bold;"><?php _e( $subject ); ?></h2>
									<br />
									<br />
									...
									<?php if ( $button && $url ) : ?>
										...
										<br />
										<br />
										<a href="<?php _e(esc_url( $url ),'sell_media'); ?>" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 26px; background-color: #ec6d4d; padding: 14px 26px; border: 1px solid #ec6d4d; font-weight: bold; text-transform: uppercase;"><?php _e( $button ); ?></a>
										<br />
									<?php endif; ?>
								</td>
								</tr>
				...
				<table width="600" cellpadding="0" cellspacing="0" align="center">
					<tr>
						<td width="600" valign="top" align="center" style="padding: 20px; font-family: Helvetica, Arial, sans-serif; color: #999999;">
							...
							&copy; <?php _e( date( 'Y' ) ); ?> <a href="<?php _e(esc_url( get_bloginfo( 'url' ) ),'sell_media'); ?>" target="_blank" style="color: #999999; text-decoration: none;"><?php _e( get_bloginfo( 'name' ) ); ?></a>
							</p>
						</td>
					</tr>
				</table>
