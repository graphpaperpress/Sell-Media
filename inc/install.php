...
function sell_media_register_post_types() {
	...
	register_post_type(
		'sell_media_payment',
		apply_filters( 'sell_media_payment_filter_post_type_registration_args', $payment_args )
	);
...
function sell_media_register_taxonomies() {
	...
	register_taxonomy(
		'price-group',
		array( 'sell_media_item' ),
		apply_filters( 'sell_media_price_group_tax_registration_args', $price_group_args )
	);
	...
	$product_type_labels = array(
		'name'              => __( 'Product Type', 'sell_media' ),
		'singular_name'     => __( 'Product Type', 'sell_media' ),
		'search_items'      => __( 'Search Product Types', 'sell_media' ),
		'all_items'         => __( 'All Product Types', 'sell_media' ),
		'parent_item'       => __( 'Parent Product Type', 'sell_media' ),
		'parent_item_colon' => __( 'Parent Product Type:', 'sell_media' ),
		'edit_item'         => __( 'Edit Product Type', 'sell_media' ),
		'update_item'       => __( 'Update Product Type', 'sell_media' ),
		'add_new_item'      => __( 'Add New Product Type', 'sell_media' ),
		'new_item_name'     => __( 'New Product Type Name', 'sell_media' ),
	);
	...
	register_taxonomy(
		'product_type',
		array( 'sell_media_item' ),
		apply_filters( 'sell_media_product_type_tax_registration_args', $product_type_args )
	);
	...
	$collection_args = array(
		...
		'show_in_rest'      => true,
		'show_in_nav_menus' => true,
		'show_admin_column' => ( ! empty( $admin_columns ) && in_array( 'show_collection', $admin_columns, true ) ) ? true : false,
		'show_ui'           => true,
		'show_tagcloud'     => true,
		'hierarchical'      => true,
	...
	register_taxonomy(
		'collection',
		array( 'sell_media_item' ),
		apply_filters( 'sell_media_collection_tax_registration_args', $collection_args )
	);
	...
	$licenses_args = array(
		...
		'show_in_rest'      => true,
		'show_in_nav_menus' => true,
		'show_admin_column' => ( ! empty( $admin_columns ) && in_array( 'show_license', $admin_columns, true ) ) ? true : false,
		'show_ui'           => true,
		'show_tagcloud'     => true,
		'hierarchical'      => true,
		'rewrite'           => true,
	...
	register_taxonomy(
		'licenses',
		array( 'sell_media_item' ),
		apply_filters( 'sell_media_licenses_tax_registration_args', $licenses_args )
	);
	...
	register_taxonomy(
		'keywords',
		array( 'attachment' ),
		apply_filters( 'sell_media_keyword_tax_registration_args', $keywords_args )
	);
	...
	$creator_args = array(
		...
		'show_in_rest'      => true,
		'show_in_nav_menus' => true,
		'show_admin_column' => ( ! empty( $admin_columns ) && in_array( 'show_creators', $admin_columns, true ) ) ? true : false,
		'show_tagcloud'     => true,
		'hierarchical'      => true,
		'rewrite'           => true,
		'query_var'         => true,
	...
	register_taxonomy(
		'creator',
		array( 'sell_media_item', 'attachment' ),
		apply_filters( 'sell_media_creator_tax_registration_args', $creator_args )
	);
	...
	*/
	...
	register_taxonomy(
		'city',
		array( 'sell_media_item', 'attachment' ),
		apply_filters( 'sell_media_city_tax_registration_args', $city_args )
	);
	...
	*/
	...
	register_taxonomy(
		'state',
		array( 'sell_media_item', 'attachment' ),
		apply_filters( 'sell_media_state_tax_registration_args', $state_args )
	);
