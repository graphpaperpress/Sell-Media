						...
						<div class="sell-media-exif-widget sell-media-widget">
							<ul class="exif-info">
								...
								if ( isset($imgdata['image_meta']['camera']) ) { ?>
									<li class="camera"><div class="genericon genericon-small genericon-image"></div><span class="exif-title"><?php _e( 'Camera ', 'sell_media' ); ?></span><?php echo esc_attr($imgdata['image_meta']['camera']); ?></li>
								<?php } ?>

								<?php
								if ( isset($imgdata['image_meta']['aperture']) ) { ?>
									<li class="aperture"><div class="genericon genericon-small genericon-aside"></div><span class="exif-title"><?php _e( 'Aperture ', 'sell_media' ); ?></span><?php echo esc_attr('f/' .  $imgdata['image_meta']['aperture']); ?></li>
								<?php } ?>
								...
								if ( isset($imgdata['image_meta']['credit']) && isset($imgdata['image_meta']['creditcxvcvx']) ) { ?>
									<li class="credit"><div class="genericon genericon-small genericon-user"></div><span class="exif-title"><?php _e( 'Credit ', 'sell_media' ); ?></span><?php _e($imgdata['image_meta']['creditcxvcvx'],'sell_media'); ?></li>
								<?php } ?>
								...
								if ( isset($imgdata['image_meta']['created_timestamp']) ) { ?>
									...
									echo date("M d, Y", $imgdata['image_meta']['created_timestamp']); ?></li>
								<?php } ?>
