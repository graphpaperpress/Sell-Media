...
gpp_register_plugin_option_tab( $general_settings_tab );

$colors_plugin_tab = array(
    "name" => "colors_plugin_tab",
    "title" => __( "Plugin Colors", "gpp" ),
    "sections" => array(
...
gpp_register_plugin_option_tab( $colors_plugin_tab );
...
$options = array(
    ...
    'font' => array(
        ...
        "type" => "select",
        "default" => "Abel:400",
        "valid_options" => gpp_plugin_font_array()
    ),
...
gpp_register_plugin_options( $options );
