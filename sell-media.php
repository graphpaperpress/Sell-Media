 ...
 * License: GPL2
 *
 * Copyright 2020 GRAPH PAPER PRESS (email: support@graphpaperpress.com)
...
if ( ! class_exists( 'SellMedia' ) ) :
	...
	final class SellMedia {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'sell_media' ), '2.5.7.4' );
		}
		...
		private function constants() {
			...
			if ( ! defined( 'SELL_MEDIA_VERSION' ) ) {
				define( 'SELL_MEDIA_VERSION', '2.5.7.4' );
			}
			...
			if ( ! defined( 'GPP_WP_KSES_EXTENDED_LIST' ) ) {
				define( 'GPP_WP_KSES_EXTENDED_LIST', [
					...
					'form'     => [ 'class' => true, 'id' => true, 'action' => 'true', 'method' => true ],
					'input'    => [ 'class' => true, 'id' => true, 'type' => true, 'value' => true, 'name' => true, 'min' => true, 'step' => true ],
					'fieldset' => [ 'class' => true, 'id' => true, 'data-*' => true ],
					'select'   => [ 'class' => true, 'id' => true, 'data-*' => true, 'required' => true ],
					'option'   => [ 'class' => true, 'id' => true, 'data-*' => true, 'selected' => true, 'title' => true, 'value' => true, 'name' => true ],
					'button'   => [ 'class' => true, 'id' => true, 'data-*' => true, 'disabled' => true, 'enabled' => true ],
					'strong'   => [ 'class' => true, 'id' => true, 'data-*' => true ],
					'p'        => [ 'class' => true, 'id' => true, 'data-*' => true ],
					'table'        => [ 'class' => true, 'id' => true, 'data-*' => true ],
