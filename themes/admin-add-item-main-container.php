...
<div class="sell-media-add-item-main-container-wrap">
	<ul class="main-container-tabs-nav">
		...
		?>
		<li id="sell-media-tab-<?php echo esc_attr( $key ); ?>">
            <a href="#sell-media-<?php echo esc_attr( $key ); ?>" class="<?php echo esc_attr( $class ); ?>"><?php echo esc_html( $tab['tab_label'] ); ?></a>
        </li>
		<?php endforeach; ?>
	</ul>
	<div class="main-container-tabs-contents">
		...
		<div id="sell-media-<?php echo esc_attr( $key ); ?>" class="ui-state-active sell-media-tab-content">
			<h3 class="sell-media-tab-content-title"><?php echo esc_html( $tab['content_title'] ); ?></h3>
			<?php
