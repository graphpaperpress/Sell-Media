                                ...
                                <a href="<?php echo get_term_link( $category->slug, $taxonomy ); ?>"><?php sell_media_item_icon( $thumb_id, apply_filters( 'sell_media_thumbnail', 'medium' ) ); ?>
                                    <span class="item-overlay">
                                        <div class="collection-details">
                                            ...
                                            <span class="collection-count"><span class="count"><?php if ( $category->count ) echo $category->count; else echo sell_media_get_cat_post_count( $category->term_id ); ?></span><?php _e( ' images in ', 'sell_media' ); ?><span class="collection"><?php echo $category->name; ?></span><?php _e(' collection', 'sell_media'); ?></span>
