    ...
    <div class="content">
        ...
        <section>
            ...
            <div class="total-container group">
                <strong><?php _e( 'Total', 'sell_media' ); ?>:</strong> <span class="price-container"><?php echo sell_media_get_currency_symbol(); ?><span id="total" class="item_price"><?php echo apply_filters( 'sell_media_cart_item_price', $price ); ?></span></span>
            </div>
