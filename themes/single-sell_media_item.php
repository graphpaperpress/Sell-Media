...
<div id="sell-media-single" class="sell-media">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div class="sell-media-meta">
			...
			<p class="sell-media-lightbox"><a href="javascript:void(0);" title="<?php _e( 'Save to lightbox', 'sell_media' ); ?>" class="add-to-lightbox" id="lightbox-<?php echo $post->ID; ?>" data-id="<?php echo $post->ID; ?>"><?php _e( 'Save to lightbox', 'sell_media' ); ?></a></p>
